...
export interface QualityScore {
  ...
  breakdown: {
    ...
    hardRules: number;          // 20 pts - Has HARD RULES or CRITICAL RULES section
    outputSchema: number;       // 20 pts - Has OUTPUT JSON SCHEMA defined
    urlValidation: number;      // 15 pts - Has URL validation requirements
    unknownHandling: number;    // 15 pts - Has unknown/fallback handling
...
function generateRecommendations(breakdown: QualityScore['breakdown']): string[] {
